...
VALUES ('Ohiopyle State Park', 'Pennsylvania', DATE '1965-01-01', 19052, 1000000, 'Ohiopyle State Park is a Pennsylvania state park on 19,052 acres in Dunbar, Henry Clay and Stewart Townships, Fayette County, 
...
VALUES (4, 'Youghioheny', 01, 12, MONEY '95.00');
...
VALUES (623, 'Wayne Family', CURRENT_DATE + 10, CURRENT_DATE + 20), (624, 'Parker Family', CURRENT_DATE + 11, CURRENT_DATE + 20), (625, 'Kent Family', CURRENT_DATE + 12, CURRENT_DATE + 20);
